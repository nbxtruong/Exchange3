/**
 * The class Currency allows to create objects representing the currency of a
 * country. Each currency is characterized by its name and contains as data 
 * its exchange rate in euro. This class gives also methods allowing to 
 * convert an amount from the currency to euro and reverse. The exchange rate 
 * in euro may be changed.
 */
...
public class Currency {
	...
	public Currency(String name, double exchangeRateInEuro) {
		this.name = name;
